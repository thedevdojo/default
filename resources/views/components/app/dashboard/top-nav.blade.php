    ...
    <div class="flex h-16 items-center gap-4 px-3 sm:px-4 lg:px-6">
        ...
        <div class="relative" data-dropdown>
            <button type="button" data-dropdown-trigger aria-expanded="false"
                    class="flex items-center gap-2 rounded-xl border border-neutral-200/90 bg-white py-1.5 pr-2.5 pl-2 shadow-xs transition-colors hover:bg-neutral-50 dark:border-white/[0.08] dark:bg-white/[0.04] dark:shadow-sm dark:hover:bg-white/[0.07]">
            ...
            <div data-dropdown-menu
                 class="absolute left-0 z-50 mt-2 w-64 origin-top-left overflow-hidden rounded-xl border border-neutral-200 bg-white p-1.5 shadow-xl dark:border-white/[0.08] dark:bg-[#0e0f15]">
                ...
                <a href="#" class="flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-100 dark:text-neutral-200 dark:hover:bg-white/[0.05]">
        ...
        <div class="ml-auto flex items-center gap-2">
            {{-- Avatar + menu --}}
            <div class="relative" data-dropdown>
                <button type="button" data-dropdown-trigger aria-expanded="false" class="flex shrink-0 rounded-full transition focus:outline-none">
                ...
                <div data-dropdown-menu
                     class="absolute right-0 z-50 mt-2 w-60 origin-top-right rounded-xl border border-neutral-200 bg-white p-1.5 shadow-xl dark:border-white/[0.08] dark:bg-[#0e0f15]">
                    <p class="truncate px-3 py-2 text-sm text-neutral-500 dark:text-neutral-400">{{ auth()->user()->email }}</p>
                    <div class="my-1 h-px bg-neutral-100 dark:bg-white/[0.06]"></div>

                    <a href="#" class="flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm text-neutral-700 transition-colors hover:bg-neutral-100 dark:text-neutral-200 dark:hover:bg-white/[0.05]">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-sm text-neutral-700 transition-colors hover:bg-neutral-100 dark:text-neutral-200 dark:hover:bg-white/[0.05]">
